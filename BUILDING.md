...
DSHub v0.1.0+ is a native Tauri desktop application. It does not run as a server and does not require PM2, Node.js, or systemd at runtime. This document covers building release packages for distribution.
...
```bash
sudo dpkg -i src-tauri/target/release/bundle/deb/DSHub_0.1.0_amd64.deb
```

### .rpm (Fedora / openSUSE / RHEL)

```bash
sudo rpm -i src-tauri/target/release/bundle/rpm/DSHub-0.1.0-1.x86_64.rpm
```
